...
const roleConfig = {
  ...
  caretaker: {
    ...
    nav: [
      { id: "overview", label: "Overview", icon: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>' },
      { id: "properties", label: "My Listings", icon: '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>' },
      ...
      <tr>
        <td colspan="5" style="padding: 4rem 2rem;">
          <div class="empty-state">
            ...
            <p>There are no houses listed yet. Add a new property to get started.</p>
            <button class="btn btn-primary mt-4">+ Add Property</button>
          </div>
        </td>
      </tr>
    `;
